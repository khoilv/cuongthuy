...
@endsection
@section('content')
<p id="pankuzu"><a href="index">TOP </a> &gt;Quản lí sản phẩm</p>
<h2 id="page_midashi_02">Quản lí sản phẩm</h2>
<!-- InstanceBeginEditable name="content_area" -->
<div class="content_list_area">
    <p class="bold"><a href="detail">&diams;Đăng kí sản phẩm mới</a></p>
    <p class="gaiyo">Bạn có thể đăng ký sản phẩm tại đây</p>
</div>
<div class="content_list_area">
    <p class="bold"><a href="search">&diams;Tìm kiếm sản phẩm</a></p>

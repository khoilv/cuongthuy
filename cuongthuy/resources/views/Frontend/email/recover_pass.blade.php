...
<html>
    ...
    <body>
    	<div class="wrapper">
            ...
            <p class="content2">
				Thân gửi {!!$user_name !!} ! <br><br>
                Theo yêu cầu quý khách, chúng tôi xin gửi lại mật khẩu của quý khách trên myphamtienthoi.vn<br>
                <b>Mật khẩu của quý khách là :</b> {!!$pass!!}<br><br>
